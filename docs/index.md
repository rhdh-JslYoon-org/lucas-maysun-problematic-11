...
!!! info
    ...
    **Source Code Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-11](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-11)

    **GitOps Repository:** [https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-11-gitops](https://github.com/rhdh-JslYoon-org/lucas-maysun-problematic-11-gitops)

# **Usage**

To access the lucas-maysun-problematic-11 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed Kubernetes resources, all resources were deployed into your chosen namespace of lucas-maysun-problematic-11. You can access this namespace through the web console or via your CLI.
